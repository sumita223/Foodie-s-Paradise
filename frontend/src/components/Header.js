    ...
    <header className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white shadow-lg p-5">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-4">
          ...
          <Link
            to="/cart"
            className="relative group px-5 py-2.5 rounded-full bg-white bg-opacity-20 hover:bg-opacity-30 transition duration-200 shadow-md hover:shadow-lg text-lg font-medium"
          >
            <ShoppingCart className="w-5 h-5 inline-block mr-2" />
            <span>Cart</span>
            {cartItems.length > 0 && (
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-white p-2 rounded-full bg-white bg-opacity-20 hover:bg-opacity-30 transition duration-200"
          onClick={toggleMenu}
        >
          {isMenuOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
        </button>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              ...
              <span className="text-white font-medium px-5 py-2.5 rounded-full bg-white bg-opacity-10 text-lg">
                {loggedInUser}
              </span>
              <button
                className="bg-amber-400 hover:bg-amber-300 text-teal-900 px-5 py-2.5 rounded-full transition duration-200 font-semibold text-lg"
